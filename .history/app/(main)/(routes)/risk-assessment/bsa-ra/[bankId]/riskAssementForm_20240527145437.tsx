...
import { useRouter } from "next/router"; // Use the correct import for next/router
...
import { bank, codeAnalyses } from "@/types"; // Ensure these types are defined in your types file
...
const RiskAssessmentForm: React.FC<RiskAssessmentFormProps> = ({
  ...
  const [banksData, setBanksData] = useState<bank>({} as bank);
  const form = useForm({
